...
<div class="admin" style="display: block;">
	...
	<ul class="control">
		...
		?>
		<li><span class="glyphicon glyphicon-off" aria-hidden="true"></span>&nbsp;<a href="resource/logout.php">Đăng xuất</a></li>
	</ul>
	<div class="clear"></div>
</div> -->
<?
