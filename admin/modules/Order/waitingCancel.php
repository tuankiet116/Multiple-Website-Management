...
<head>
    ...
    <link rel="stylesheet" href="../../resource/css/waiting_cancel.css">
    ...
    <script language="javascript" src="../../resource/js/waiting_cancel.js"></script>
    ...
    <div class="container-fluid">
        ...
        <div class="section-list">
            <div class="title-list">
                <p>Danh Sách Đơn Hàng Chờ Hủy</p>
            </div>
            <table class="table">
                <thead>
                    <tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" id ="confirm_cancel_order">Xác Nhận Hủy Đơn</button>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" id="close_modal_detail">Đóng</button>
                </div>
            </div>
        </div>
    </div>
