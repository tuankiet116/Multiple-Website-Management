...
class OrderUser
{
    ...
    private function createOrderCOD(){
        if($this->getCartInformation() === true){
            ...
            $query = 'INSERT INTO order_tb(order_id, user_id, order_payment_status, order_payment, web_id, order_sum_price, order_datetime, order_status, order_description)
                        VALUES(:order_id, :user_id, 0, 1, :web_id, :order_sum_price, CURRENT_TIMESTAMP(), 1, :order_description)';
            $stmt = $this->prepareQueryPDO($query);
