...
<body>
	...
	<!-- <center style=" position: realative; z-index: 9999;">
	...
	<div class="hover">
		<div class="mgs">
			<p>Phiên Đăng Nhập Hết Hạn, <span id="redirect" >vui lòng đăng nhập lại</span></p>
		</div>
	...
	<script>
		var href = document.getElementById('redirect');
		href.onclick = function(){
			window.parent.location.href = '../admin/login.php'
		}
	</script>
</body>
